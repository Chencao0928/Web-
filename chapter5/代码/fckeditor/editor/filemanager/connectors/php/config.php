...
$http_path = substr($_SERVER['PHP_SELF'], 0, -1 * (strlen($_SERVER['PHP_SELF']) - strrpos($_SERVER['PHP_SELF'], '/'))) ;
$_SERVER['SCRIPT_FILENAME'] = str_replace('\\', '\\\\', $_SERVER['SCRIPT_FILENAME']) ;
$path = substr($_SERVER['SCRIPT_FILENAME'], 0, -1 * (strlen($_SERVER['SCRIPT_FILENAME']) - strrpos($_SERVER['SCRIPT_FILENAME'], '\\'))) ;
$Config['UserFilesPath'] = $http_path.'/upfiles/' ;
$Config['UserFilesAbsolutePath'] = ((strpos($_SERVER["SERVER_SOFTWARE"], 'apache') === false) ?$path.'\\upfiles\\' : '') ;
